...
const buttonVariantsLanding = cva(
...
export interface ButtonProps
    extends React.ButtonHTMLAttributes<HTMLButtonElement>,
        VariantProps<typeof buttonVariantsLanding> {
    asChild?: boolean;
    spinner?: boolean;
    href?: string;
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        return (
            <Comp
                className={cn(buttonVariantsLanding({ variant, size, className }))}
                ref={ref as any}
                href={href || undefined}
                {...props}
            >
...
export { Button, buttonVariantsLanding };